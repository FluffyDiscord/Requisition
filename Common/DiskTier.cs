namespace TerraStorage.Common
{
    ...
    public static class DiskTierExtensions
    {
        ...
        /// <summary>Returns the maximum number of item stacks this tier can hold.</summary>
        ...
        /// <summary>Returns the UI accent color used to visually distinguish this tier.</summary>
